...
from openenv_quant.env.base_state import ScenarioState
from openenv_quant.tasks.task1_data_verification import evaluate_data_readiness
from openenv_quant.tasks.task2_system_monitoring import system_unresolved_issues
from openenv_quant.tasks.task3_execution_assistance import evaluate_execution_complete
from openenv_quant.utils.constants import ACTION_TYPES, ALL_TOOLS, BROKERS, DECLARE_FLAGS, URGENCY_LEVELS
...
def check_terminal_conditions(state: ScenarioState, recency_limit_minutes: int) -> Tuple[bool, bool, Dict[str, Any]]:
    event: Dict[str, Any] = {}
    from openenv_quant.utils.constants import Stage
